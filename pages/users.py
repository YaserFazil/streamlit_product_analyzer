...
def protected_page():
    if (
        ...
        column_configuration = {
            ...
            "memento_token": st.column_config.TextColumn("Memento DB Account Token", help="Generate Token in Memento DB Account and Paste it", max_chars=200, required=False),
